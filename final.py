...
image1 = Image.open("C:\\Users\\KizorSelvaraj\\Desktop\\Final_Project\\1.png")
...
with st.sidebar:    
    selected = option_menu("Main menu", ["Customer Conversion", "Image processing","NLP Pre-processing","Recommendation"], 
...
selected
df = pd.read_csv("C:\\Users\\KizorSelvaraj\\Desktop\\Final_Project\\data.csv")

#--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#:customer churn prediction:
if selected == "Customer Conversion":
    with open("C:\\Users\\KizorSelvaraj\\Desktop\\Final_Project\\modelgrad.pkl","rb") as f:
...
if selected=="Recommendation":
    ...
    df = pd.read_csv("C:\\Users\\KizorSelvaraj\\Desktop\\Final_Project\\spotify.csv")
